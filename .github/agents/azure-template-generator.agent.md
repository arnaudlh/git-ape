...
```json
{
  ...
  "metadata": {
    "description": "Generated by AutoCloud with CAF-compliant naming",
  ...
  "resources": [
    {
      ...
      "name": "[variables('rgName')]",
      "location": "[parameters('location')]",
      "tags": { "Environment": "[parameters('environment')]", "Project": "[parameters('projectName')]", "ManagedBy": "autocloud-agent" }
    },
    {
      "type": "Microsoft.Resources/deployments",
      "apiVersion": "2024-03-01",
