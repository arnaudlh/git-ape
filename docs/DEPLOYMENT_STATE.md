...
```bash
.github/scripts/deployment-manager.sh validate deploy-20260218-163500
```
...
- [Azure MCP Setup Guide](./AZURE_MCP_SETUP.md)
- [Integration Testing Guide](../skills/azure-integration-tester/SKILL.md)
