...
- [Deployment State Management](./DEPLOYMENT_STATE.md)
- [Azure MCP Setup](./AZURE_MCP_SETUP.md)
- [CAF Naming Conventions](../.github/copilot-instructions.md)
- [Integration Testing](../.github/skills/azure-integration-tester/SKILL.md)
