...
- [AZURE_MCP_SETUP.md](../getting-started/azure-setup)
- [ONBOARDING.md](../getting-started/onboarding)
- [DEPLOYMENT_STATE.md](../deployment/state)
- [DRIFT_DETECTION.md](../deployment/drift-detection)